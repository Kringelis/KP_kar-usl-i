...
const PievienotieDati = () => {
  ...
  const [selectedColorType, setSelectedColorType] = useState("outlineColor");
  ...
  const handleColorChange = (id, color) => {
    const newUserGraphics = userGraphics.map((item) =>
      item.id === id ? { ...item, [selectedColorType]: color } : item
    );
              ...
              <div className="icons">
                <button
                  className={`color-type ${
                    selectedColorType === "outlineColor" ? "selected" : ""
                  }`}
                  onClick={() => setSelectedColorType("outlineColor")}
                >
                  Outline
                </button>
                <button
                  className={`color-type ${
                    selectedColorType === "fillColor" ? "selected" : ""
                  }`}
                  onClick={() => setSelectedColorType("fillColor")}
                >
                  Fill
                </button>
