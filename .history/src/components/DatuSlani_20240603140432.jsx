...
const DatuSlani = () => {
  ...
  const handleSelectAll = (keys, selectAll, setSelectAll) => {
    const newToggleStates = { ...toggleStates };
    keys.forEach((key) => {
      newToggleStates[key] = !selectAll;
    });
            ...
            <div className="select-all">
              <label>
                <input
                  ...
                  checked={selectAll1}
                  onChange={() =>
                    handleSelectAll(karuRamjiKeys, selectAll1, setSelectAll1)
                  }
                />
                <span className="select-all-text">Rādīt visu</span>
              </label>
            </div>
            {karuRamjiKeys.map((item) => (
